...
$db = dbconnect();
$query = "select b_title, b_content, b_id, b_password from board_free where b_no = '{$bNo}'";
...
<div id="boardWrite">
  <form action="index.php?page=writeup" enctype="multipart/form-data" method="post">
    <?php
    if(isset($bNo)) {
echo '<input type="hidden" name="bno" value="' . $bNo . '">';
    ...
    <div class="btnSet">
      ...
      <a href="index.php?page=board" class="btnList btn">List</a>
    </div>
  </form>
</div>
</article>
