<?php
  ...
  $p = $_GET['p'] ? $_GET['p'] : 1;
        $db = dbconnect();
  $query = "select * from board_free where b_title like '%{$w}%' order by b_no desc";
...
<td class="title"><a href="./?page=pass&bno=<?php echo $row['b_no']?>&admin=no"><?php echo $row['b_title']?></td>
...
<tr>
<td class="no"></td>
<td class="title">　　　　　　　　　　<<<　　　　 <a href="index.php?page=board&p=1&w=<?=$w?>">1</a><a href="index.php?page=board&p=2&w=<?=$w?>"> 2</a><a href="index.php?page=board&p=3&w=<?=$w?>"> 3</td>
<td class="author"　>>>></td>
<td class="date"></td>
<td class="hit"></td>
</tr>
