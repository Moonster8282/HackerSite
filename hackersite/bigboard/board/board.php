...
<form name="input" action="/hackersite/?page=board" method="POST">
...
onclick="window.location.href='?page=write'">Write
</button>
</span>
</tr>
</table>
		...
		<table>
			...
			<tbody>
        <?php require_once("bigboard/board/list.php"); #글 리스트 불러오는 소스코드 ?>
			</tbody>
		</table>
		</div>
	</article>
